...
--
-- Host: localhost:8889
-- Generation Time: Nov 29, 2019 at 04:02 AM
...
(2, 'TRAA website', 'Web designer', 'This is a project that I did with my friend - Jimmy. I played a designer role on this project. I arranged all the infomation on the actual website Anglers.org and redesign the whole website. My main idea about this project is that create a simple website that people easy to follow the information and the news.', 'anglers.org', 'traabg.jpg'),
